<template>
    <div>
        ...
        <template v-else>
            <Select transfer v-model="valueObj" multiple :disabled="disabled" :placeholder="formItem.componentParams.placeholder||formItem.componentParams.selectText" @on-change="updateValue">
