...
&lt;!&ndash;        <template v-if="innerToolbar.btns" v-for="(toolbarBtn,index) in innerToolbar.batchBtns">
...
&lt;!&ndash;        <div style="width:77px;display:table-cell;vertical-align:middle;background-color:#fff;">
