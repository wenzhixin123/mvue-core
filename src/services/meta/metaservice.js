...
var customActions = {
    ...
    getFormByDefaultShortId: {method: 'GET', url: 'meta_form/default/short{/id}'},
    ...
    getViewByDefaultShortId: {method: 'GET', url: 'meta_view/default/short{/id}'},
...
export default{
    ...
    getFormByDefaultShortId:$resource.getFormByDefaultShortId,
    getViewByDefaultShortId:$resource.getViewByDefaultShortId
